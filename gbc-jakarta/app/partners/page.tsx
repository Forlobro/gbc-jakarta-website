...
export default function PartnersPage() {
  ...
  // Category names for filter buttons — "All" + fetched categories
      ...
      <section className="pt-32 pb-36 bg-[#f8fafc] relative" id="companies">
        ...
        <div className="max-w-350 mx-auto px-[5%] relative z-[2]">
          ...
          {!loading && categoryNames.length > 1 && (
            <div className="flex gap-2 mb-10 overflow-x-auto pb-2 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
